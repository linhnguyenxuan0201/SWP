...
<body>
    ...
    <div class="mt-5">
        ...
        <div class="mt-2">
            <div class="w-screen grid grid-cols-[repeat(auto-fit,_16.666666%)] gap-4 justify-center">
                <img src="./img/logo gucci.jpg" alt="" class="max-h-[200px]" />
                <img src="./img/Louis_Vuitton_logo.jpg" alt="" class="max-h-[200px]" />
            </div>
        </div>
    </div>
    <div class="mt-5">
