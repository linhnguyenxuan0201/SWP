                ...
                <div class="mt-5">
                    ...
                    <form action="#" method="post">
                        <div class="flex space-x-3">
                            ...
                            <input type="text" placeholder="Họ: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                            </div>
                            
                            <div class="">
                            <label for="ten" class="m-2.5">Tên*</label>
                            <input type="text" placeholder="Tên: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                            </div>
                        </div>
                        ...
                        <div class="">
                            ...
                            <input type="text" placeholder="Email: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                        </div>
                        
                        <div class="">
                            <label for="ten" class="m-2.5">Phone*</label>
                            <input type="text" placeholder="Phone: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                        </div>
                        
                        <div class="">
                            <label for="ten" class="m-2.5">Mật khẩu*</label>
                            <input type="text" placeholder="Mật khẩu: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                        </div>
                                                
                        <div class="">
                            <label for="ten" class="m-2.5">Nhập lại mật khẩu*</label>
                            <input type="text" placeholder="Nhập lại mật khẩu: *" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                        </div>
                        
                        <div class="">
                            <label for="ten" class="m-2.5">Ngày sinh*</label>
                            <input type="date" placeholder="dd/mm/yyyy" required readonly
                                   class="w-full p-3 m-2.5 border border-solid border-[#ccc] rounded" />
                        </div>
                        
                        <div class="grid justify-items-center">
                        <button type="submit" class="bg-[#e60000] cursor-pointer rounded text-white py-1.5 w-[20rem] mt-5 hover:bg-[#cc0000]">Chỉnh sửa profile</button>
                        </div>
                    </form>
                </div>
            </div>
