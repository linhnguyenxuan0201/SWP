                ...
                <div class="">
                    ...
                    <form action="OTP" method="post">
                            <div class="flex mt-5 flex-row">
                                <p class="py-2 mr-3 text-center align-middle basis-1/5">Nhập OTP:</p>
                                <input type="text" placeholder="" 
                                       class="py-2 pl-2 text-black placeholder-black bg-gray-200 w-[45rem] text-center basis-3/5" />
                            </div>

                            <div class="flex mt-5 flex-row">
                                <p class="py-2 mr-3 text-center align-middle basis-1/5">Nhập mật khẩu mới:</p>
                                <input type="text" placeholder=""
                                       class="py-2 pl-2 text-black placeholder-black bg-gray-200 w-[45rem] text-center basis-3/5" />
                            </div>
