...
<html>
    ...
    <body>
        ...
        <!-- RIGHT -->
        <p class="text-center mt-6 text-2xl sm:ml-64">QUẢN LÝ TỒN KHO</p>
        <div class="flex flex-col h-screen p-4 sm:ml-64">
            ...
            <table class="table-auto border-black border-2">
                <thead class="bg-gray-300">
                    <tr>
                        <th class="p-4 border-b border-slate-200">Order ID</th>
                        <th class="p-4 border-b border-slate-200">User</th>
                        <th class="p-4 border-b border-slate-200">Date</th>
                        <th class="p-4 border-b border-slate-200">Total Amount</th>
