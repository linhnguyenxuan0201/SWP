    ...
    <div class="App">
        ...
        <div class="border flex p-5 text-black justify-center text-center">
            <div class="">
                ...
                <div class="flex mt-5">
                    <p class="py-2 mr-3 text-center align-middle">Email:</p>
                    <input type="text" placeholder="" class="py-2 pl-2 ml-8 text-black placeholder-black bg-gray-200 w-[30rem] text-center" />
                </div>
                    
                <div class="flex justify-evenly">
                    <button class="bg-yellow-600 text-black py-1.5 w-[20rem] mt-5">
                        Gửi OTP
                    </button>
                </div>
                </form>
